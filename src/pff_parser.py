...
def build_trace_model_prompt(trace_detail):
    ...
    lines = [
        ...
        "Код в TRACE может быть неполным фрагментом; если данных строки недостаточно, восстанавливай полный код по Mxx:Line в исходном модуле, просмотрев соседние строки.",
